...
public class GetStringApiTest extends ApplicationTestCase<Application> {
    ...
    public void testSynchronousStringGetRequest() {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousStringGetRequest404() {
    ...
    @SuppressWarnings("unchecked")
    public void testSyncResponseBodyGet() throws IOException {
    ...
    @SuppressWarnings("unchecked")
    public void testSyncResponseBodyGet404() throws IOException {

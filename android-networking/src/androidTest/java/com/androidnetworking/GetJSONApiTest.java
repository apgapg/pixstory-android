...
public class GetJSONApiTest extends ApplicationTestCase<Application> {
    ...
    public void testSynchronousJSONObjectGetRequest() throws JSONException {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousJSONObjectGetRequest404() {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousJSONArrayGetRequest() throws JSONException {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousJSONArrayGetRequest404() {

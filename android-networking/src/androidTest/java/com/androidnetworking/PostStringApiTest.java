...
public class PostStringApiTest extends ApplicationTestCase<Application> {
    ...
    public void testSynchronousStringPostRequest() {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousStringPostRequest404() {
    ...
    @SuppressWarnings("unchecked")
    public void testSyncResponseBodyPost() throws IOException {
    ...
    @SuppressWarnings("unchecked")
    public void testSyncResponseBodyPost404() throws IOException {

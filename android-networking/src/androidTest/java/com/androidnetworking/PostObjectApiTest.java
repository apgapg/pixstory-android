...
public class PostObjectApiTest extends ApplicationTestCase<Application> {
    ...
    public void testSynchronousObjectPostRequest() {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousObjectPostRequest404() {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousObjectListPostRequest() {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousObjectListPostRequest404() {

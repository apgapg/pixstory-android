...
public class MultipartStringApiTest extends ApplicationTestCase<Application> {
    ...
    public void testSynchronousStringMultipartRequest() {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousMultipartRequest404() {
    ...
    @SuppressWarnings("unchecked")
    public void testSyncResponseBodyMultipart() throws IOException {
    ...
    @SuppressWarnings("unchecked")
    public void testSyncResponseBodyMultipart404() throws IOException {

...
public class MultipartObjectApiTest extends ApplicationTestCase<Application> {
    ...
    public void testSynchronousObjectMultipartRequest() {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousObjectMultipartRequest404() {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousObjectListMultipartRequest() {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousObjectListMultipartRequest404() {

...
public class MultipartJSONApiTest extends ApplicationTestCase<Application> {
    ...
    public void testSynchronousJSONObjectMultipartRequest() throws JSONException {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousJSONObjectMultipartRequest404() {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousJSONArrayMultipartRequest() throws JSONException {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousJSONArrayMultipartRequest404() {

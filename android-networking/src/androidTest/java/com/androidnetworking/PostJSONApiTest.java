...
public class PostJSONApiTest extends ApplicationTestCase<Application> {
    ...
    public void testSynchronousJSONObjectPostRequest() throws JSONException {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousJSONObjectPostRequest404() {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousJSONArrayPostRequest() throws JSONException {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousJSONArrayPostRequest404() {

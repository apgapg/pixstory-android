...
public class GetObjectApiTest extends ApplicationTestCase<Application> {
    ...
    public void testSynchronousObjectGetRequest() {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousObjectGetRequest404() {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousObjectListGetRequest() {
    ...
    @SuppressWarnings("unchecked")
    public void testSynchronousObjectListGetRequest404() {

...
public class DialogActivity extends AppCompatActivity implements DialogActivityView {

    private DialogActivityPresentor mPresentor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPresentor = new DialogActivityPresentor(((AppController) getApplication()).getmAppDataManager());

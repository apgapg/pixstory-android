...
public class DetailSheetFragment extends BottomSheetDialogFragment {
    ...
    public void setupDialog(final Dialog dialog, final int style) {
        ...
        final ArrayList<String> arrayList = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.detail_story_array)));
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(dialog.getContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(final View view, final int position) {
                switch (position) {
                    case 0:
//                        reportUser();
                        Toast.makeText(dialog.getContext(), "Api hit of Report", Toast.LENGTH_SHORT).show();
                        break;
                    case 1:
//                        followUser();
                        Toast.makeText(dialog.getContext(), "Api hit of save", Toast.LENGTH_SHORT).show();
                        break;
                    default:
                        break;
                }
